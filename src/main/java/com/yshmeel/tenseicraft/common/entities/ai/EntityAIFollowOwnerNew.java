package com.yshmeel.tenseicraft.common.entities.ai;
...
public class EntityAIFollowOwnerNew extends EntityAIBase {
    private final EntityClone tameable;
    ...
    public EntityAIFollowOwnerNew(EntityClone tameableIn, double followSpeedIn, float minDistIn, float maxDistIn) {
