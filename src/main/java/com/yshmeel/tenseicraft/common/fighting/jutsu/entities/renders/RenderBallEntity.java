package com.yshmeel.tenseicraft.common.fighting.jutsu.entities.renders;
...
public class RenderBallEntity extends Render<EntityBall>
{
    private final float scale;

    public RenderBallEntity(RenderManager renderManagerIn, float scaleIn)
    {
    ...
    {
        return (entity.jutsuTexture == null ? new ResourceLocation(Tensei.MODID, "textures/jutsu/balls/default.png") :
                entity.jutsuTexture);
    }
}